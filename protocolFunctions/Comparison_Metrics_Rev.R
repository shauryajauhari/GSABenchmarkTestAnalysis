...
#disease_pools <- trimws(paste0(as.character(unique(tolower(ChIPSeqDataMaster$Disease...Target..Pathway))),"_id_pool"))
...
cat("\nPrioritization:",for_prioritization)
#return(for_surrogate_sensitivity)
